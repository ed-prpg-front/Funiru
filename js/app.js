...
new Swiper('.slider-inspiration__container', {
   loop: true,
   slidesPerView: "auto",
   spaceBetween: 24,
   slidesOffsetAfter: 0,
   pagination: {
      el: '.slider-inspiration-bullet',
      type: 'bullets',
   },
   effect: 'coverflow',
   coverflowEffect: {
...
new Swiper('.tips__inner-container', {
   breakpoints: {
      992: {
         loop: true,
         slidesPerView: 3,
   ...
   navigation: {
      nextEl: '.tips__arrow-prev',
      prevEl: '.tips__arrow-next',
   },
});